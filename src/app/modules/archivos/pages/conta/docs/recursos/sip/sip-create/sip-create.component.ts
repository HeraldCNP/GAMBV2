...
@Component({
  selector: 'app-sip-create',
  templateUrl: './sip-create.component.html',
  styleUrls: ['./sip-create.component.css']
})
export class SipCreateComponent implements OnInit {
  idUser: any;
  user: any;
  data: any;
  sipForm:any;
  ...
  crearDeven() {
    ...
    if (!this.sipForm.value.archivo) {
      ...
      fd.append('numero', this.sipForm.value.numero);
      fd.append('fecha', this.sipForm.value.fecha);
      fd.append('glosa', this.sipForm.value.glosa);
      fd.append('monto', this.sipForm.value.monto);
      fd.append('fojas', this.sipForm.value.fojas);
      fd.append('observacion', this.sipForm.value.observacion);
