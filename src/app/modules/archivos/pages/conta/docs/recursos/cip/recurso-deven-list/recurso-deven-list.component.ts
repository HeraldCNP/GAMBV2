...
@Component({
  selector: 'app-recurso-deven-list',
  templateUrl: './recurso-deven-list.component.html',
  styleUrls: ['./recurso-deven-list.component.css']
})
export class RecursoDevenListComponent implements OnInit {
