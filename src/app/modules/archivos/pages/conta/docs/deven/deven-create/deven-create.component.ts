...
@Component({
  selector: 'app-deven-create',
  templateUrl: './deven-create.component.html',
  styleUrls: ['./deven-create.component.css']
})
export class DevenCreateComponent implements OnInit {
  idUser: any;
  user: any;
  data: any;
  devenForm:any;
  ...
  crearDeven() {
    ...
    if (!this.devenForm.value.archivo) {
      ...
      fd.append('beneficiario', this.devenForm.value.beneficiario);
      fd.append('ci', this.devenForm.value.ci);
