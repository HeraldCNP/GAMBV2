...
@Component({
  ...
  templateUrl: './carpeta-index.component.html',
  styleUrls: ['./carpeta-index.component.css']
})
export class CarpetaIndexComponent implements OnInit {
  totalCarpetas: any = 0;
  carpetas: any = [];
  carpetasTemp: any = [];
  skip: number = 1;
  ...
  addCarpeta() {
    this.router.navigate(['archivos/carpetas/create']);
  }
